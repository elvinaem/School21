...
int is_octal_digit(unsigned char c);
int is_hex_digit(unsigned char c);
void skip_whitespace(const char** str);
int is_width(unsigned char c);
int is_symbol_num(unsigned char c);
int is_length(unsigned char c);
